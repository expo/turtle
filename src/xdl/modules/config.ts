...
function defaults(
  defaultConfig: INativeConfig,
  ...customConfigs: Array<Partial<INativeConfig> | undefined>
) {
  return Object.assign({}, defaultConfig, ...customConfigs);
}

export const expoSdkUniversalModulesConfigs: IModuleConfig[] = expoUniversalModules.map(
  ({
    config = {},
    podName,
    libName,

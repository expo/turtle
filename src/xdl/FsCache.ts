...
*/
class Cacher<T> {
  public refresher: () => Promise<T>;
  public filename: string;
  public bootstrapFile?: string;
  public ttlMilliseconds: number;

  public readError?: any;
  public writeError?: any;
      ...
      try {
        ...
        if (this.bootstrapFile) {
          const bootstrapContents = (
            await fs.readFile(this.bootstrapFile)
          ).toString();
